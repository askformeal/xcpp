...
// compile this file using "g++ -o xcpp xcpp.cpp" and push xcpp.exe into C:\Windows\System32 folder
...
int main(int argc, char*argv[])
{
    ...
    */
    ...
    if (filename == "-h" || argc < 2)
    {
        ...
        cout << "Xcpp Version 0.0.0\n";
        cout << "Usage: xcpp file-name [-options]\n";
        cout << "-c only compile\n";
        cout << "-r only run\n";
        cout << "-h show help\n";
        cout << "Github: https://github.com/askformeal/xcpp";
        return 0;
    }
    ...
    else if (argc == 3)
    {
        ...
        else
        {
            ...
            cout << "*Error:*\n\tWrong index, enter \"xcpp -h for help\"\n";
            return 0;
        }
    }
